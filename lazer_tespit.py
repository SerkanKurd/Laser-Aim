...
def main():
    ...
    while True:
        ...
        for i in range(num_rings, 0, -1):
            ...
            cv2.circle(frame, center, radius, (255, 0, 0), 2) # Mavi renkte hedef halkaları
            
            # Halkaların üzerine puanları yazdır
            cv2.putText(frame, str(ring_score), (center[0] - 10, center[1] - radius + 20), 
        ...
        for hit in hits:
            ...
            cv2.putText(frame, f"+{score}", (pos[0]+10, pos[1]-10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, color, 2)
        ...
        cv2.putText(frame, f"Vurus Sayisi: {len(hits)}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
        cv2.putText(frame, f"Toplam Puan: {total_score}", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
        cv2.putText(frame, "Temizle: C | Cikis: Q", (10, height - 20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (200, 200, 200), 1)
